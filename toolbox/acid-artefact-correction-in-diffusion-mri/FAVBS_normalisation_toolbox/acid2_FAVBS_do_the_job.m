function out = acid2_FAVBS_do_the_job(rVb0, rVFA, rVmean, FA_on, iter,MSKperc, VGstemp, SCI, cutoffIN)
    ...
    switch FA_on
        case 0
            if(SCI==1)
                ...
                matnames = acid2_norm_spm_FAVBS(VG,rVb0,'',FA_on,iter,MSKperc);
            end
        case 1 
            if(SCI==1)
                matnames = norm_spm_FAVBS_SM_SC(VG,rVFA,rVmean,FA_on,iter,MSKperc);
            else
                matnames = acid2_norm_spm_FAVBS(VG,rVFA,rVmean,FA_on,iter,MSKperc);
            end
        case 2 
            if(SCI==1)
                matnames = norm_spm_FAVBS_SM_SC(VG,rVFA,rVmean,FA_on,iter,MSKperc);
            else
                [matnames, fmatnames] = acid2_norm_spm_FAVBS(VG,rVFA,rVmean,FA_on,iter,MSKperc);
            end
    end
