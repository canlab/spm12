%-----------------------------------------------------------------------
% Job saved on 16-Jul-2015 08:05:38 by cfg_util (rev $Rev: 6134 $)
% spm SPM - SPM12 (6225)
...
matlabbatch{1}.spm.util.defs.out{2}.pull.fnames = '<UNDEFINED>';
matlabbatch{1}.spm.util.defs.out{2}.pull.savedir.savesrc = 1;
