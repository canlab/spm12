function favbs_acid = tbxdti_cfg_favbs_norm
...
cutoff         = cfg_entry;
cutoff.tag     = 'cutoff';
cutoff.name    = 'Cutoff in mm';
cutoff.help    = {'This measure is inverse proportional to the number of cosines used for normalization. '};
cutoff.strtype = 'e';
cutoff.num     = [1 1];
cutoff.val     = {25};
% ---------------------------------------------------------------------
...
SCDTI           = cfg_menu;
SCDTI.tag       = 'SCDTI';
SCDTI.name      = 'Use the spinal cord modus';
SCDTI.help      = {'Choose whether you want to use the spinal cord modus. This modus works best if the MD contrast is used under b0 normalization.'
                         };
SCDTI.labels    = {
               'YES'
               'NO'
...
favbs_acid.val     = {PFA Pb0 Pmean norm MSKperc SCDTI cutoff};
