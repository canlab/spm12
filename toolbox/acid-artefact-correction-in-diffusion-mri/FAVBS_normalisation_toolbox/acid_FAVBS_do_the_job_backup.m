function out = acid_FAVBS_do_the_job(rVb0, rVFA, rVmean, FA_on, iter,MSKperc, VGstemp)
...
while(procent_diff>2 && ddiff>2),
    ...
    switch FA_on
        case 0
            matnames = acid_norm_spm_FAVBS(VG,rVb0,'',FA_on,iter,MSKperc);
        case 1
            matnames = acid_norm_spm_FAVBS(VG,rVFA,rVmean,FA_on,iter,MSKperc);
        case 2
            [matnames, fmatnames] = acid_norm_spm_FAVBS(VG,rVFA,rVmean,FA_on,iter,MSKperc);
    end
