function [p,f] = spm_powell_VARTARG(p,xi,tolsc,func,freeze,varargin)
...
%------------------------------------------------------------------------
% Modified Siawoosh Mohammadi 10/01/2014
% Modification:
% - the freeze parameter is included
