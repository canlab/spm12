#ifndef lint
static char sccsid[] = "@(#)spm_hist2_z_exp_polyval2.c	2.9 John Ashburner 01/09/28";
...
double* get_matrix (double z)
{
    ...
    *zp = z;
    ...
    mexCallMATLAB (1, plhs, 1, prhs, "make_matrix_polyval2");
    if (!mxIsDouble(plhs[0])) {
        mexErrMsgTxt("make_matrix must return double");
    }
